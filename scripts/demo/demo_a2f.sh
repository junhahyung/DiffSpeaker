...
# scaled - not working
#--checkpoint experiments/a2f/diffusion_bias/diffspeaker_hubert_a2f_scaled/checkpoints/epoch=499.ckpt

python demo_a2f.py \
    --cfg configs/diffusion/a2f/diffspeaker_hubert_a2f.yaml \
    --cfg_assets configs/assets/a2f.yaml \
    --example demo/wavs/ALDECALDO_BARD_q114_f_1C3C9CCD543C5000.wav \
    --checkpoint experiments/a2f/diffusion_bias/diffspeaker_hubert_a2f/checkpoints/epoch=499.ckpt \
