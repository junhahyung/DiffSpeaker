...
class A2FDataset(data.Dataset):
    ...
    def __init__(self, 
        ...
        self.one_hot_labels = np.eye(len(subjects))
    ...
    def __getitem__(self, index):
        ...
        subject = self.data[index]["subject_id"]
        one_hot = self.one_hot_labels[self.subjects.index(subject)]
        '''
